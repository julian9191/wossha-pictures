...
public class EventListener {
    ...
    public void consume(String json) {
        ...
        try {
            ...
            logger.debug("New Event received in "+WosshaPicturesApplication.APP_NAME+": "+ root.path("name").asText());
            ...
            if (es != null) {
                ...
                logger.debug("Event received in "+WosshaPicturesApplication.APP_NAME+" without listener " + json);
            }
